...
*/
class testCallInstance extends base
{
    ...
    public function testInstanceClassDoesNotExistException()
    {
    ...
    {
        $this->setExpectedException('Hive\Config\Exception\ArgumentDoesNotExist');

        \Hive\Config\Instance::MockInherit('bluebannanan');
    }
    ...
    public function testArgumentsDoesNotExistException ()
    {
        ...
        $config = \Hive\Config\Instance::MockNested('DoesNotExist');
